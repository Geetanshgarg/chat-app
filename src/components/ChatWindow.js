...
export default function ChatWindow({ chatId }) {
  ...
  return (
    <Card className="h-[90vh] relative">
      <CardHeader className="border-b h-[60px] flex flex-row items-center bg-background/95">
      ...
      <CardFooter className="border-t absolute bottom-0 w-full bg-background/95">
